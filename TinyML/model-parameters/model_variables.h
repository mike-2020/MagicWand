...
const char* ei_classifier_inferencing_categories[] = { "circle", "idle", "left_right", "up_down" };
...
const ei_impulse_t impulse_439470_0 = {
    .project_id = 439470,
    .project_owner = "www www",
    .project_name = "gesture_class_ESP32_dataForwarder",
    .deploy_version = 5,

    .nn_input_frame_size = 33,
    .raw_sample_count = 120,
    .raw_samples_per_frame = 3,
    .dsp_input_frame_size = 120 * 3,
    .input_width = 0,
    .input_height = 0,
    .input_frames = 0,
    .interval_ms = 16.666666666666668,
    .frequency = 60,
...
ei_impulse_handle_t impulse_handle_439470_0 = ei_impulse_handle_t( &impulse_439470_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_439470_0;
